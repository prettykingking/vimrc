...
syn region  htmlTag                start=+<[^/]+   end=+>+ contains=htmlTagN,htmlString,htmlArg,htmlValue,htmlTagError,htmlCssDefinition,@htmlPreproc,@htmlArgCluster
...
if main_syntax != 'java' || exists("java_javascript")
  ...
  syn region  htmlScriptTag     contained start=+<script+ end=+>+       contains=htmlTagN,htmlString,htmlArg,htmlValue,htmlTagError
